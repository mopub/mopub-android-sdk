    ...
    private void preparePlayer() {
        if (mExoPlayer == null) {
            ...
            mVideoTrackRenderer = new MediaCodecVideoTrackRenderer(
                    ...
                    MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT_WITH_CROPPING, 0, mHandler, null, 10);
            mAudioTrackRenderer = new MediaCodecAudioTrackRenderer(sampleSource, MediaCodecSelector.DEFAULT);
